...
from preprocess import deap_preprocess, DEAPDataset
...
if __name__ == "__main__":
    ...
    # DEAP path
    dataset_dir = "/date/lty/suanfaku/acrnn/deap/deap_shuffled_data/"

    if not os.path.exists(dataset_dir):
        print(f"Warning: Dataset directory not found: {dataset_dir}")
        print("Please update the dataset_dir variable with your actual DEAP data path")
    ...
    for run_id in run_pbar:
        ...
        tqdm.write("Loading DEAP dataset...")
